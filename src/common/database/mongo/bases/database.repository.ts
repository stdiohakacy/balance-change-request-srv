...
} from '@common/database/mongo/interfaces/database.interface';
import { UpdateResult, DeleteResult, InsertManyResult } from 'mongodb';
import { ENUM_PAGINATION_ORDER_DIRECTION_TYPE } from 'src/common/pagination/enums/pagination.enum';
import { DatabaseSoftDeleteDto } from '@common/database/mongo/dtos/database.soft-delete.dto';
import { DatabaseEntityBase } from '@common/database/mongo/bases/database.entity';
